...
- Choose the `model` called `GPT`. 
- On the `information_agent` page, take the defaults for **Profile** and **Knowledge** sections. 
...
- Click on **Local instance**.
  ...
  <img width="1000" alt="image" src="./screenshots_hands_on_lab/local_instance_1.png">

- Select the `Search Travily` tool and press `Add to agent`.

  <img width="1000" alt="image" src="./screenshots_hands_on_lab/Screenshot 2026-01-14 at 08.40.41.png">
...
- Navigate to the **Knowledge** section and click `Add source`.



  <img width="1000" alt="image" src="./screenshots_hands_on_lab/add_knowl_1.png">

- Add an `Existing knowledge` source called `Automobile Insurance Knowledge Base` and press `Add knowledge`

  <img width="1000" alt="image" src="./screenshots_hands_on_lab/Screenshot 2026-01-14 at 08.53.12.png">
  <img width="1000" alt="image" src="./screenshots_hands_on_lab/Screenshot 2026-01-14 at 08.57.19.png">

- In the **Toolset** section, click on **Add tool** 

  <img width="1000" alt="image" src="./screenshots_hands_on_lab/customer/customer-8.png">

- Click on **Local instance** and add the tools `Create a Claim Request` and `Check Claim Status` to the agent.
...
- Click on **Local instance** and add the following three tools to the `Claims Processor Agent`:
  - `Fetch Open Claims`
  - `Update Claim Status`
  - `Get Top 5 Open Claims`


- Next, click on **Add Agent** in the Agents section.
